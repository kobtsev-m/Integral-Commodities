...
function OrderStep3() {
  ...
  return (
    <section className={classes.orderContainer}>
      ...
      <h1 className={classes.step3__title}>Counterparty form</h1>
      <div className={classes.step3__tabs}>
        <a
      ...
      <div className={classes.step3__beforeForm}>
        <p className={classes.step3__textContent}>
