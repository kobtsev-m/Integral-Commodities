...
import { mapContainerStyle } from '../settings/PriceMap.settings';
import { mapCenter, mapZoom, mapOptions } from '../settings/PriceMap.settings';
import { mapGlobalStyles, getMarkerFields } from '../styles/PriceMap.styles';
import {
  getInfoWindowOffset,
  getInfoWindowSize
} from '../styles/PriceMap.styles';
